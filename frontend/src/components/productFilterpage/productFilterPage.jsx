...
const ProductFilterPage = () => {
  ...
  if (nestedCategories) {
    console.log("categories nest:", nestedCategories);
  }
  ...
  async function fetchDataFromBackend() {
    ...
    try {
      ...
      console.log("Data fetched from backend by octave");
  ...
  const convertToNestedStructure = (categoriesArray) => {
    ...
    return nestedCategories.map((category) => ({
      ...
      value: category._id,
      children: convertToNestedStructureRecursive(category.children, true),
      showCheckbox: false,
    }));
  };

  const convertToNestedStructureRecursive = (children, isFirstLevel) => {
    return children.map((child) => ({
      ...
      children: convertToNestedStructureRecursive(child.children, false),
      showCheckbox: false,
    }));
  };
        ...
        <main className=" w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              {/* <div className="hidden lg:inline-block relative mr-5">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                >
                  <CheckboxTree
                    icons={{
                      expandClose: <RightOutlined />,
                      expandOpen: <DownOutlined />,
                    }}
                    showNodeIcon={false}
                    showExpandAll={false}
                    nodes={nestedCategories}
                    checked={checked}
                    expanded={expanded}
