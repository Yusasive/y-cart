...
const PromoSection4 = () => {
  return (
    <div className="container mx-auto py-9 md:py-12 px-4 md:px-6 my-5">
      <div className="flex items-strech justify-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8">
        <div className="flex flex-col md:flex-row items-strech justify-between bg-lime-300 py-6 px-6 md:py-12 lg:px-12 md:w-8/12 lg:w-7/12 xl:w-8/12 2xl:w-9/12">
        ...
        <div className="md:w-4/12 lg:w-5/12 xl:w-4/12 2xl:w-3/12 bg-red-300 py-6 px-6 md:py-0 md:px-4 lg:px-6 flex flex-col justify-center relative">
